...
import { PostCardItems } from "@/constants/postCardDetails";
...
interface PostCard {
  postCard: PostCardItems[];
}

export default function ProjectCarousel({ postCard }: PostCard) {
  ...
  const maxIndex = Math.max(0, postCard.length - itemPerView);
